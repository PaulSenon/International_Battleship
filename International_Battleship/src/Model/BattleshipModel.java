...
public class BattleshipModel implements BattleshipGameModel {
    ...
    public BattleshipModel() {
    	battleshipImplementor = new BoatsImplementor(this.players, this.BoatChoosed());
    }
    ...
    public LinkedList<BoatName> BoatChoosed(){
    	LinkedList<BoatName> boatChoosed = new LinkedList<BoatName>();
    	for (BoatName boatName : BoatName.values()) {
			boatChoosed.add(boatName);
		}
